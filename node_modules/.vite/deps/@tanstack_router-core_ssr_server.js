import { createPlugin, crossSerializeStream, getCrossReferenceHeader } from "./seroval.js";
import { a as defaultSerovalDeserializerPlugins, c as encodeText, d as ShallowErrorPlugin, l as pumpEncodedStream, r as createRawStreamRPCPlugin, s as ReadableStreamPlugin, t as mergeHeaders, u as toBase64 } from "./headers-M6qL2qbV.js";
import { t as RawStream } from "./RawStream-uHAXOAr2.js";
import { $ as dehydrateSsrMatchId, i as decodePath, it as rootRouteId, st as waitForReason, v as _getRenderedMatches } from "./utils-Z0venMGr.js";
import { createServerHistory } from "./@tanstack_history.js";
import { c as getStylesheetHref, i as createInlineCssStyleAsset, r as createInlineCssPlaceholderAsset } from "./manifest-B9BXHOub.js";
import { t as require_browser_external_node_stream } from "./browser-external_node_stream-DGi1A9VS.js";
...
var HydrationScriptsOwner = class {
	...
	*/
	disableHydration() {
		if (this.consumer === "cleaned" || this.outputState === HydrationScriptOutputState.Failed) return;
		if (this.initialTaken || this.consumer !== void 0 || this.producerDone) throw new Error("Invariant failed: hydration output is already committed; disableHydration() must run before <Scripts> renders and before serialization starts.");
...
function attachRouterServerSsrUtils({ router, manifest, getRequestAssets }) {
	...
	const serverSsr = {
		...
		dehydrate: async (opts) => {
			if (dehydrationPhase !== "idle") throw new Error(dehydrationPhase === "disabled" ? "Invariant failed: hydration is disabled for this request!" : "Invariant failed: router is already dehydrated!");
		...
		disableHydration: () => {
			...
			if (dehydrationPhase !== "idle") throw new Error("Invariant failed: cannot disable hydration after dehydrate()!");
...
function transformPipeableStreamWithRouter(router, routerStream, opts) {
	return import_browser_external_node_stream.Readable.fromWeb(transformReadableStreamWithRouter(router, import_browser_external_node_stream.Readable.toWeb(routerStream), opts));
}
