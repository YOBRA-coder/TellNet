...
//#region node_modules/.nitro/vite/services/ssr/assets/operator-session.server-CcB7by9_.js
var operator_session_server_CcB7by9__exports = /* @__PURE__ */ __exportAll({
...
var COOKIE_NAME = "__Host-telnet-operator";
var SESSION_DURATION_SECONDS = 28800;
function getSecret() {
	const secret = process.env.BETTER_AUTH_SECRET?.trim() || process.env.OPERATOR_SESSION_SECRET?.trim();
	if (!secret) throw new Error("BETTER_AUTH_SECRET or OPERATOR_SESSION_SECRET must be configured");
...
//#endregion
export { hasOperatorSession as n, operator_session_server_CcB7by9__exports as r, createOperatorSession as t };
