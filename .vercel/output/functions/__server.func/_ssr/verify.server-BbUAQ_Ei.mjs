...
import { n as authConfigured, r as gateIdentityEnabled, t as auth } from "./server-CItOiXTe.mjs";
import { n as hasOperatorSession } from "./operator-session.server-CcB7by9_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/verify.server-BbUAQ_Ei.js
/**
...
async function requireUserId(bearerToken) {
	if (await hasOperatorSession()) return "operator";
