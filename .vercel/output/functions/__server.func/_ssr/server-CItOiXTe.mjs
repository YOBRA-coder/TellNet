...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-CItOiXTe.js
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./ssr.mjs").then((n) => n.d).then((n) => n.t);
...
//#endregion
export { PACKAGE_VERSION as a, GENERIC_OAUTH_ERROR_CODES as i, authConfigured as n, getBaseURL as o, gateIdentityEnabled as r, auth as t };
