...
import { i as logoutOperator } from "./public-D6kztkSL.mjs";
import { t as useOperatorSession } from "./operator-_KXLRQpx.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/route-7GeBy2mH.js
...
function OperatorUserButton() {
	...
	async function handleSignOut() {
		...
		setBusy(true);
		try {
			if (!(await logoutOperator()).ok) throw new Error("Sign-out failed");
			await navigate({
				to: "/login",
				replace: true
			});
